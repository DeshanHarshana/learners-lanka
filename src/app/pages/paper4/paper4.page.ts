...
export class Paper4Page implements OnInit {
  ...
  answerarr=[4,2,3,4,3,1,3,1,4,2,1,3,2,1,4,2,4,1,1,1]
  questionNo=0;
...
nextQuestion(){
  ...
  this.imageHidden=true;
    ...
    this.q2="ඔබට ඉදිරියෙන් ධාවනය වන වාහනයේ රියැදුරු තැන හදිසියේ නතර කළහොත්  ඔබට ඔබගේ වාහනය ආරක්ෂාකාරී ලෙස නතර කරගැනීමට හැකිවන නිසාය";
  ...
  this.imageHidden=true;
    ...
    this.q3="ඔබගේ වාහනය වේගය වැඩි නොකර පසු කරන්නාට ඔබගේ වාහනය පසුකර යාමට ඉඩ දිය යුතුය";
